...
/*   Updated: 2023/04/25 17:54:19 by ageels        ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
// P U B L I C
ClapTrap::ClapTrap(std::string name) {
	std::cout << "CT constructor(name) called, creating: " << name << std::endl;
	this->_name = name;
	this->_hp = 10;
	this->_energy = 10;
	this->_damage = 0;
...
ClapTrap::~ClapTrap() {
	std::cout << "CT " << this->_name << ": default destructor called" << std::endl;
}

ClapTrap	&ClapTrap::operator=(ClapTrap const &src)
{
	std::cout << "CT '=' sign operator called" << std::endl;
